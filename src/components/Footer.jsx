                    ...
                    <Row>
                        <Col xs={12} md={2}>
                            <ul className="d-flex flex-column flex-start footer-list p-0">
                                <li className="list-item" style={{ color: "#687888" }}>
                                    <a href="/">About</a>
                                </li>
                                <li className="list-item" style={{ color: "#687888" }}>
                        ...
                        <Col xs={12} md={3}>
                            <div className="d-flex flex-column footer-list p-0">
                                <div className="d-flex list-item">
                                    ...
                                    <div>
                                        <h6 style={{ color: "#56687a", fontSize: ".85rem" }} className="mb-0">
                                            Questions?
                                        </h6>
                                        <span>
                                ...
                                <div className="d-flex list-item">
                                    ...
                                    <div>
                                        <h6 style={{ color: "#56687a", fontSize: ".85rem" }} className="mb-0 w-100">
                        ...
                        <Col xs={12} md={3}>
                            <div className="d-flex flex-column flex-center footer-list p-0">
                                <div className="list-item">
                                    <p className="mb-1" style={{ color: "#687888" }}>
                                        {" "}
                                        Select Language
                                    </p>
                                    ...
                                    <Dropdown className="d-flex" style={{ borderRadius: "15px" }}>
                                        <Dropdown.Toggle
                                            className="w-100 flex-start"
                                            style={{ color: "#6f6e6d", background: "#f3f2ef", borderColor: "grey", textAlign: "left" }}
                                            variant="light"
                                            id="dropdown-basic"
                                        >
                                            English (English)
