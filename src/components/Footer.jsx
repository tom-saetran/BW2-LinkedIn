...
class Footer extends React.Component {
    ...
    render() {
        ...
        return (
            <Container>
                <Row>
                <svg className="mr-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 84 21" data-supported-dps="84x21" fill="currentColor" class="mercado-match" width="84" height="21" focusable="false">
                        <g>
