        ...
        return (
            <Row className="g-0">
                ...
                <div className="mb-5 banner-parent">
                    ...
                    <img className="img-fluid" style={{height: "54px", width: "100%"}} height="100px" src="https://www.publicdomainpictures.net/pictures/320000/velka/background-image.png"></img>
                    <img className="img-fluid img-overlay3" width="85px"  src="https://miro.medium.com/max/1200/1*mk1-6aYaf_Bes1E3Imhc0A.jpeg"></img>
                    </div>
                ...
                <Col xs={12} className="section-outer">
                    <div className="inner-small-items">
                        ...
                        <h6 className="mt-4"><a style={{ textDecoration: "none" }} href="/">Groups</a></h6>
                    ...
                    <h6 className="py-1 mb-0"><a style={{ textDecoration: "none" }} href="/">Events</a></h6>
                        <svg className="me-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" data-supported-dps="16x16" fill="currentColor" width="16" height="16" focusable="false">
                        <path d="M14 9H9v5H7V9H2V7h5V2h2v5h5z"></path>
                        </svg>

                    </div>
                    <h6 className="py-1 mt-1 mb-0"><a style={{ textDecoration: "none" }} href="/">Followed Hashtags</a></h6>
                    </div>
