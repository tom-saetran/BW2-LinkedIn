            ...
            <Col xs={12} className="p-0 mb-4 section-outer">
                <div style={{ padding: "12px 12px 0px 12px" }} className="d-flex">
                    <img
                        ...
                        src={(this.props.post.user && this.props.post.user.image) || "https://via.placeholder.com/200x200?text=Profile+picture"}
                    />
                    ...
                    <div className="ms-2 d-flex flex-column">
                        ...
                        <span className="text-muted">
                            {this.props.post &&
                                new Date(this.props.post.createdAt).getHours() +
                                    ":" +
                                    new Date(this.props.post.createdAt).getMinutes() +
                                    " - " +
                                    new Date(this.props.post.createdAt).toDateString()}{" "}
                            ·{" "}
                            <svg
                ...
                <div className="d-flex px-3 pb-3 align-items-center">
                    <img
                        ...
                        src={this.props.me.image || "https://via.placeholder.com/200x200?text=Profile+picture"}
                    ></img>
