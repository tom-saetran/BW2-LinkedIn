...
class ExperienceEducation extends React.Component {
    ...
    componentDidUpdate = async (_previousProps, _previousState) => {
        if (_previousProps.match.params.id !== this.props.match.params.id) this.setState({ experiences: await this.props.crud.experiences.getAll(this.props.match.params.id) });
    };
                            ...
                            return (
                                <div key={"experience" + index} className="mb-3">
                                    <div className="d-flex">
                                        <img className="medium-logo mt-2 mr-2" src={experience.image ? experience.image : "https://via.placeholder.com/200x200?text=Experience"} alt="" />
                                        <div>
                                        ...
                                        <div className="ml-auto">
                                            <span title="Edit this experience" className="cursor-pointer">
                                                <UpdateExperienceModal onUpdate={this.onUpdate} user={this.props.user} crud={this.props.crud} experience={experience} />
                                            </span>
                                            <span title="Remove this experience" className="cursor-pointer">
                                                <RemoveExperienceModal onUpdate={this.onUpdate} user={this.props.user} crud={this.props.crud} experience={experience} />
                                            </span>
                                        </div>
                                    </div>
                                </div>
                ...
                <Form noValidate validated={validated} onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <Modal.Body>
                        <Form.Group controlId="formRole">
                            ...
                            <Form.Control className="card-border text-dim cursor-text no-active-outline" type="text" required value={role} onChange={(e) => setRole(e.target.value)} />
                        </Form.Group>
                        <Form.Group controlId="formCompany">
                            <Form.Text className="pl-1 text-dim">Company</Form.Text>
                            <Form.Control className="card-border text-dim cursor-text no-active-outline" type="text" required value={company} onChange={(e) => setCompany(e.target.value)} />
                        </Form.Group>
                        ...
                        <Form.Group controlId="formArea">
                            ...
                            <Form.Control className="card-border text-dim cursor-text no-active-outline" type="text" required value={area} onChange={(e) => setArea(e.target.value)} />
                        </Form.Group>
                        <Form.Group controlId="formStartDate">
                            <Form.Text className="pl-1 text-dim">Start Date</Form.Text>
                            <Form.Control className="card-border text-dim cursor-text no-active-outline" type="date" required value={startDate} onChange={(e) => setStartDate(e.target.value)} />
                        </Form.Group>
                        <Form.Group controlId="formEndDate">
                            <Form.Text className="pl-1 text-dim">End Date (if applicable)</Form.Text>
                            <Form.Control className="card-border text-dim cursor-text no-active-outline" type="date" value={endDate} onChange={(e) => setEndDate(e.target.value)} />
                        </Form.Group>
                    </Modal.Body>
            ...
            <Modal show={show} onHide={handleClose}>
                <Form noValidate validated={validated} onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group controlId="formCompany">
                            <Form.Text className="pl-1 text-dim">Company</Form.Text>
                            <Form.Control className="card-border text-dim cursor-text no-active-outline" as="textarea" rows={2} required value={company} onChange={(e) => setCompany(e.target.value)} />
                        </Form.Group>
                        <Form.Group controlId="formDescription">
                            <Form.Text className="pl-1 text-dim">Description</Form.Text>
                            <Form.Control className="card-border text-dim cursor-text no-active-outline" type="text" required value={description} onChange={(e) => setDescription(e.target.value)} />
                        </Form.Group>
                        <Form.Group controlId="formArea">
                            <Form.Text className="pl-1 text-dim">Area</Form.Text>
                            <Form.Control className="card-border text-dim cursor-text no-active-outline" type="text" required value={area} onChange={(e) => setArea(e.target.value)} />
        ...
        <OverlayTrigger
            ...
            overlay={
                <Popover id={"emojiPop_"}>
                    ...
                    <Popover.Content>
                        Add clickable emojis here. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iusto nulla sapiente voluptatem voluptas dolorum porro explicabo aspernatur pariatur sed
                        eveniet placeat amet vero, ipsam expedita quidem odit adipisci quis facilis!
                    </Popover.Content>
                </Popover>
            }
        >
