                    ...
                    <Container>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav" className="ml-auto me-md-5">
                            <Nav>
                                ...
                                <Nav.Link href="#link" className="NavLinks d-md-flex flex-md-column ">
                                ...
                                <Nav.Link className="NavLinks d-md-flex flex-md-column ">
                                ...
                                <div className="d-flex flex-column align-items-center">
                                    <svg className="justify-content-right p-0" id="global-nav-icon--classic__work" height="24" width="24">
