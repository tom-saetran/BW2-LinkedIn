                ...
                <Navbar bg="white" expand="lg" className="pt-1 px-0 pl-0 pb-0">
                    <Container>
                        ...
                        <Form inline className="d-flex h-50 my-auto" style={{backgroundColor:"#eef3f8"}}>
                                    <Button type="submit"className="border-white me-auto " variant="outline-none" className="input-group-append">
                        ...
                        <Navbar.Collapse id="basic-navbar-nav" class="ml-auto me-md-5">
                            <Nav>
                                ...
                                <Nav.Link className="NavLinks" href="#link" className="d-md-flex flex-md-column ">
