            ...
            <div>
                <Navbar bg="white" expand="lg" className="pt-1 px-0 pl-0 pb-0">
                    <Container>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav" style={{flexGrow:0}} className=" me-md-5">
                            <Nav>
                                <Nav.Link href="#home" className="d-md-flex flex-md-column nav-links">
                                ...
                                <Nav.Link href="#link" className="NavLink d-md-flex flex-md-column nav-links">
                                ...
                                <Nav.Link href="#link" className="NavLinks d-md-flex flex-md-column nav-links">
                                ...
                                <Nav.Link className="NavLinks d-md-flex flex-md-column nav-links">
                                ...
                                <div className="d-flex flex-md-column align-items-center">
                                    <img className="mb-0" style={{ borderRadius: "50%" }} width="24" src="https://media-exp1.licdn.com/dms/image/C4D03AQEmFglnfuuwIA/profile-displayphoto-shrink_100_100/0/1611490819975?e=1626307200&amp;v=beta&amp;t=w9AyTKktD9nM_YOIbxdofqnBn-EkVTEd3wNs4z7JxRU" height="24" alt="Carl Dawkins" id="ember34" className="mx-auto global-nav__me-photo ember-view" />
                                    <NavDropdown id="Me" title="Me" className="nav-links" >
