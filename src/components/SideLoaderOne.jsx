                ...
                <Col xs="12">
                    ...
                    <Container id="top-two">
                        <h6 id="top-two-text">
                            ...
                            <Badge className="text-secondary" variant="secondary">
                                ?
                            </Badge>
                        </h6>
                    </Container>
                                    ...
                                    <ListGroup.Item id="SideLoaderOneItem">
                                        <Card id="side-card">
                                            <Card.Header id="side-card-title">
                                                <h2 className="">People also viewed</h2>
                                            </Card.Header>
                                                        ...
                                                        <Card.Body id="generated-card" key={person._id}>
                                                            <Row className="flex-row">
                                                                ...
                                                                <Col xs={8} id="card-column">
                                                                    <Card.Title>
                                                                        {person.name}
                                                                        <span id="person-title"> : {person.title}</span>
                                                                    </Card.Title>
                                                                    <Card.Text>
                                ...
                                <ListGroup id="SideLoaderOneGroup">
                                    ...
                                    <div id="div-drop-one">
                                        <DropdownButton variant="outline-secondary" id="sl-one-drop" title="Show more">
                                            ...
                                            <Dropdown.Item id="drop-down-button" as="button">
                                                Action
                                            </Dropdown.Item>
                                            <Dropdown.Item id="drop-down-button" as="button">
                                                Another action
                    ...
                    <Container>
                        <ListGroup id="side-loader-youtube">
                            <ListGroup.Item>
                                <image id="id-image" src="https://www.flaticon.com/svg/vstatic/svg/174/174857.svg?token=exp=1620736913~hmac=530637a5e41aa0928527217e985055de"></image>LEARNING
                            </ListGroup.Item>
